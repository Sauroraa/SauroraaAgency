...
export default function NewArtistPage() {
  ...
  const mutation = useMutation({
    mutationFn: async () => {
      ...
      const payload = {
        name: form.name,
        realName: clean(form.realName),
        bioShort: clean(form.bioShort),
        bioFull: clean(form.bioFull),
        country: form.country,
        city: clean(form.city),
        availability: form.availability,
        spotifyUrl: clean(form.spotifyUrl),
        soundcloudUrl: clean(form.soundcloudUrl),
        ...
        accountLanguage: clean(form.accountEmail) ? form.accountLanguage : undefined,
        technicalRider: clean(form.technicalRider),
        hospitalityRider: clean(form.hospitalityRider),
        stagePlotUrl: clean(form.stagePlotUrl),
        inputListUrl: clean(form.inputListUrl),
        presskitTitle: clean(form.presskitTitle),
        presskitTemplate: clean(form.presskitTemplate),
